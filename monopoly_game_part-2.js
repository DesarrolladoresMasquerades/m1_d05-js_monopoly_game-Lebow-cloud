...
class Player {
  ...
  move() {
    ...
    this.position = (this.position + dice) % squares.length;  // CIRCULAR BUFFER
...
var player1 = new Player("Dani", "Green");
var player2 = new Player("Pedrito", "Pink");
var player3 = new Player("Samanta", "Red");
...
class Game {
  constructor() {
    // --- Initialization of players ---
    let player1 = new Player("Dani", "Green");
    let player2 = new Player("Pedrito", "Pink");
    let player3 = new Player("Samanta", "Red");
